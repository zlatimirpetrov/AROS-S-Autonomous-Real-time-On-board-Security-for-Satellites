...
def transform_smap_to_aros(nasa_df, seed=42):
    """
    ...
    aros_data['CPU_load']= rng.uniform(15, 45, size=len(nasa_df))
    aros_data['RAM_usage']= rng.uniform(200, 600, size=len(nasa_df))
